...
public class PlatformCatalogService {
    ...
    public List<OaMenuItemDto> menus() {
        return List.of(
                ...
                group("workflow", "流程中心", "/my-work", 30,
                        ...
                        leaf("workflow-form-design", "设计表单", "/placeholder/workflow/forms", "workflow", "cataloged", 110),
                        leaf("workflow-process-design", "设计流程", "/placeholder/workflow/processes", "workflow", "cataloged", 120),
    ...
    public List<OaModuleDto> modules() {
        return List.of(
                ...
                module("knowledge", "知识管理", "知识库、案件自动归档、文件预览下载、版本与权限", "P0", "partial",
                        "目录权限", "文件版本", "案件归档", "下载留痕", "全文检索"),
                module("judicial", "司法鉴定完整业务", "20 个流程、19 个表单、角色、文件、归档和版本", "P0", "cataloged",
    ...
    public List<ReconstructionPhaseDto> reconstructionPlan() {
        return List.of(
                phase("第一阶段", "公共平台与可运行骨架", "in_progress",
                        "修复现有登录/组织/用户管理构建缺口",
                        "建立完整 OA 菜单与模块范围台账",
                        "建立司法鉴定 20 流程/19 表单元数据",
                        "前端补齐登录、首页、个人资料、用户管理和平台总览"),
                phase("第二阶段", "流程平台核心", "planned",
                        "动态表单定义、版本和渲染",
                        "动态流程定义、节点、连线、办理人规则",
                        "我的工作、工作查询、监控、日志、委托、销毁、归档"),
                phase("第三阶段", "知识与文件平台", "planned",
                        "MinIO 文件服务、预览下载、查重、版本",
                        "案件节点自动归档",
                        "目录/文件/案件权限和下载审计"),
                phase("第四阶段", "司法鉴定业务高保真", "planned",
                        "逐一落地 20 个流程定义",
                        "逐节点角色、条件分支、退回路径、子流程和并行",
                        "鉴定意见书初稿、A、A-B、A-B-C、最终送审稿版本保留"),
