    ...
    public List<OaMenuItemDto> menus() {
        return List.of(
                group("quick", "快捷菜单", "/placeholder/quick", 10,
                        leaf("quick-mail", "电子邮件", "/placeholder/quick/mail", "quick", "partial", 10),
                        leaf("quick-calendar", "日程", "/placeholder/quick/calendar", "quick", "partial", 20),
                        leaf("quick-knowledge", "知识库", "/knowledge", "knowledge", "implemented", 30)),
                group("personal", "个人事务", "/placeholder/personal", 20,
                        leaf("personal-message", "消息", "/placeholder/personal/message", "personal", "partial", 10),
                        leaf("personal-task", "任务", "/placeholder/personal/task", "personal", "partial", 20),
                        leaf("personal-log", "工作日志", "/placeholder/personal/log", "personal", "partial", 30),
                        leaf("personal-address", "通讯簿", "/placeholder/personal/address", "personal", "partial", 40)),
                ...
                group("business", "业务管理", "/placeholder/business", 50,
                        leaf("crm", "CRM", "/placeholder/crm", "crm", "partial", 10),
                        leaf("performance", "绩效", "/placeholder/performance", "performance", "partial", 20),
                        leaf("contract", "合同", "/placeholder/contract", "contract", "partial", 30),
                        leaf("project", "项目", "/placeholder/project", "project", "partial", 40),
                ...
                group("people-docs", "人资/考勤/公文/档案", "/placeholder/people-docs", 90,
                        ...
                        leaf("archive", "档案", "/placeholder/archive", "archive", "partial", 40),
                ...
                group("system", "系统管理", "/admin/users", 110,
                        ...
                        leaf("system-permission", "权限管理", "/placeholder/system/permission", "system", "partial", 20),
                        leaf("system-log", "管理日志", "/placeholder/system/log", "system", "partial", 30),
