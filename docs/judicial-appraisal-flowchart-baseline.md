...
- 已按运行时分支测试完成：收到委托书、初步勘验、发交费通知书及相关函件、编制内部质量控制文件、现场勘验、材料接收与返还、鉴定意见书征求意见稿送审编制、鉴定意见书送审稿编制、出具鉴定意见书、出具征求意见稿、收到法院其他函件（含异议函）、收到出庭通知、不予受理、收到撤案函。
- 已完成真实浏览器页面验证：多角色登录、新建工作按角色展示、草稿删除、工作查询详情、我的工作待办办理、办结只读详情、项目负责人页面提交流转。
- 部分完成但仍需专项补齐：退费流程、终止鉴定、归档、用章申请表。
- 待继续按流程图补齐：财务报销，以及数据报表、知识库批量下载、流程图视图、经办人只读通知模型等公共能力。
